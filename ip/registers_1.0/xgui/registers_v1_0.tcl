...
proc init_gui { IPINST } {
  ...
  set C_AXI_DATA_WIDTH [ipgui::add_param $IPINST -name "C_AXI_DATA_WIDTH" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Width of S_AXI data bus} ${C_AXI_DATA_WIDTH}
  set C_AXI_ADDR_WIDTH [ipgui::add_param $IPINST -name "C_AXI_ADDR_WIDTH" -parent ${Page_0}]

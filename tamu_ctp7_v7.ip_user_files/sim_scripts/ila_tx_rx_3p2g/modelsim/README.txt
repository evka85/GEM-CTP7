...
#
# Generated by export_simulation on Fri Apr 08 04:50:23 CEST 2016
#
################################################################################
...
switch to the './ila_tx_rx_3p2g.sh' script.

./ila_tx_rx_3p2g.sh -reset_run
...
./ila_tx_rx_3p2g.sh -noclean_files

For more information on the script, please type './ila_tx_rx_3p2g.sh -help'.

...
#
# Generated by export_simulation on Thu Apr 14 09:25:15 CEST 2016
#
################################################################################
...
switch to the './ila_axi_ipbus_bridge.sh' script.

./ila_axi_ipbus_bridge.sh -reset_run
...
./ila_axi_ipbus_bridge.sh -noclean_files

For more information on the script, please type './ila_axi_ipbus_bridge.sh -help'.

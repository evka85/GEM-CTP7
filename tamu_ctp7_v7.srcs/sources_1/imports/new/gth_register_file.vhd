...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH2, 17)  => oh_reg_request_arr_o(C_CH2).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH2).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH3, 17)  => oh_reg_request_arr_o(C_CH3).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH3).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH4, 17)  => oh_reg_request_arr_o(C_CH4).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH4).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH5, 17)  => oh_reg_request_arr_o(C_CH5).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH5).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH6, 17)  => oh_reg_request_arr_o(C_CH6).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH7).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH8).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH6).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
--          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH7, 17)  => oh_reg_request_arr_o(C_CH7).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH7).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
--          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH8, 17)  => oh_reg_request_arr_o(C_CH8).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH8).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH9, 17)  => oh_reg_request_arr_o(C_CH9).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH9).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH10, 17) => oh_reg_request_arr_o(C_CH10).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH10).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
          when addr_encode(C_GTH_OH_REG_EN_CH0_ADDR, C_GTH_CH_to_CH_ADDR_OFFSET, C_CH11, 17) => oh_reg_request_arr_o(C_CH11).en <= BRAM_CTRL_GTH_REG_FILE_din(0); oh_reg_request_arr_o(C_CH11).we <= BRAM_CTRL_GTH_REG_FILE_din(1); 
------------------------------------------------------------------------------------------------------------------------------------------------------
